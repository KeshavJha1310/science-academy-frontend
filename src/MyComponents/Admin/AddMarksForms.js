...
const AddMarksForms = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("http://127.0.0.1:5000/api/addMarks", formData)
      .then((res) => {
  ...
  const fetchExamDetails = (selectedId) => {
    axios
      .get("http://127.0.0.1:5000/api/getLaunchedExam")
      .then((response) => {
...
const fetchClassData = () => {
  axios
    .get("http://127.0.0.1:5000/api/classData")
    .then((res) => {
...
const fetchStudents = (className) =>{
  axios.get('http://127.0.0.1:5000/api/studentsList')
  .then(res => {
